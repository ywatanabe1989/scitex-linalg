"""Sphinx configuration for scitex-linalg."""
...
project = "scitex-linalg"
copyright = "2026, Yusuke Watanabe"
author = "Yusuke Watanabe"

try:
    from scitex_linalg import __version__ as release
except ImportError:
    release = "0.1.0"
...
autodoc_mock_imports = ["torch", "geom_median", "sympy"]
