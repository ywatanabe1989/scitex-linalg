...
# (project=scitex-linalg, owner=ywatanabe1989, repo=scitex-linalg,
...
TMPDIR="/tmp/publish-scitex_linalg-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-linalg dist/* uploaded to PyPI via manual OIDC trusted publishing"
